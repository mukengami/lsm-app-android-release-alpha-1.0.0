package org.lsm.mobile.authentication;

import android.support.annotation.NonNull;

import com.google.inject.Inject;

import org.lsm.mobile.http.constants.ApiConstants;
import org.lsm.mobile.http.constants.ApiConstants.TokenType;
...
import static org.lsm.mobile.http.constants.ApiConstants.URL_MY_USER_INFO;
...
public interface LoginService {
     ...
     * In case of validation errors the response body will be {@link org.lsm.mobile.model.api.FormFieldMessageBody}.
     */
    @NonNull
    @FormUrlEncoded
