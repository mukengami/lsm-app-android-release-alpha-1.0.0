...
import org.lsm.mobile.model.course.EncodedVideos;
...
import org.lsm.mobile.view.adapters.CourseUnitPagerAdapter;
import org.lsm.mobile.view.custom.DisableableViewPager;
...
public class CourseUnitNavigationActivityTest extends CourseBaseActivityTest {
    ...
    public static class ParameterizedFragmentCreation extends UiTest {
        ...
        public void test() throws IOException {
            config = new org.lsm.mobile.util.Config(generateConfigProperties());
